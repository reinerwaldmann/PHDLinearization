...
def deriv_func_seq (fun_seq, argseq, arginitseq, n=1):
    ...
    на выходе возвращает словарь строкое функции - значение производной
...
def countDispLinearization (fun_seq, argseq, arginitseq, V):
    """
    Возвращает считает дисперсию по матожиданию и ковариационной матрице
