...
список входных переменных с разбросом, в строковом представлении
Vx, ковариационная матрица входных переменных с разбросом. Диагональная Vx говорит о наличии дисперсии, но отсутствии ковариации
